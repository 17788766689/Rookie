...
//        updateStatus(platform, Const.AJW_VA);
    ...
    private void login() {
        ...
        request.headers("user-agent","15(Android/7.1.1) (io.dcloud.UNIB205D0A/1.0.1) Weex/0.26.0 1080x1920");
    ...
    private void getAccount() {
        ...
        HttpClient.getInstance().post("/api/index/get_taobao_info", mPlatform.getHost())
                ...
                .headers("user-agent","15(Android/7.1.1) (io.dcloud.UNIB205D0A/1.0.1) Weex/0.26.0 1080x1920")
                    ...
                    public void onSuccess(Response<String> response) {
                        try {
                            ...
                            if (JSONObject.parseObject(response.body()).getString("message") != null && !JSONObject.parseObject(response.body()).getString("message").equals("")){
                                ...
                                receiveSuccess(String.format(MyApp.getContext().getString(R.string.KSHG_AW_tips), mPlatform.getName()), R.raw.xiaopingguopdd, 3000);

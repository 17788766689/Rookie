 ...
 * 多多花苑
 */
public class DDHYAction extends BaseAction {
...
//        updateStatus(platform, Const.AJW_VA);
    ...
    private void login() {
        ...
        HttpClient.getInstance().post("/auth/login_4_worker_web", mPlatform.getHost())
    ...
    private void startTask() {
        HttpClient.getInstance().get("/task/list_plan?pageNum=1&type=1&pageSize=10&keyLike=&completeFlag=0&cancelFlag=0", mPlatform.getHost())
                ...
                .headers("Referer", "http://wx.xdhfnch.cn:8081/workerIndex")
                .headers("User-Agent", "Mozilla/5.0 (Linux; Android 10; MI 9 Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/74.0.3729.186 Mobile Safari/537.36 Html5Plus/1.0")
                .execute(new StringCallback() {
                    @Override
                    public void onSuccess(Response<String> response) {
                    ...
                    public void onSuccess(Response<String> response) {
                        try {
                            ...
                            if (2000 == jsonObject.getIntValue("code")) {
                                ...
                                receiveSuccess(String.format(MyApp.getContext().getString(R.string.KSHG_AW_tips), mPlatform.getName()+"店铺名:"+shopName), R.raw.duoduohuayuan, 3000);

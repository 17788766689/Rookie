 ...
 * 云宝
 */
public class YBAction extends BaseAction {
...
//        updateStatus(platform, Const.AJW_VA);
    ...
    private void login() {
        ...
        HttpClient.getInstance().post("/Common/UserLogin", mPlatform.getHost())
                ...
                .params("allContact","[]")
                .params("phoneId",""+ Utils.getRandomNickname(10))
                .headers("Content-Type","application/x-www-form-urlencoded; charset=UTF-8")
                .headers("Referer","http://m.fanpnsn.cn/Login?returnUrl=http://m.fanpnsn.cn/")
    ...
    private void getAccount() {
        HttpClient.getInstance().get("/AutoJiedan", mPlatform.getHost())
    ...
    private void startTask() {
        ...
        HttpClient.getInstance().post("/tools/task_ajax.ashx?action=get_task_result", mPlatform.getHost())
                ...
                .params("longitude",Utils.getRandom(3)+""+Utils.getRandom(6))
                .params("latitude",Utils.getRandom(2)+""+Utils.getRandom(6))
                .params("phoneId",Utils.getRandomNickname(10))
                .headers("Cookie", cookie)
                .headers("Content-Type","application/x-www-form-urlencoded; charset=UTF-8")
                .headers("Referer","http://m.fanpnsn.cn/AutoJiedan")
                .headers("User-Agent","Mozilla/5.0 (Linux; Android 5.0; SM-G900P Build/LRX21T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Mobile Safari/537.36")
                .headers("X-Requested-With","XMLHttpRequest")
                .execute(new StringCallback() {
                    @Override
                    public void onSuccess(Response<String> response) {
                        try {
                            ...
                            if (1 == jsonObject.getIntValue("status")) {    //接单成功
                                ...
                                receiveSuccess(String.format(MyApp.getContext().getString(R.string.KSHG_AW_tips), mPlatform.getName()), R.raw.tansen, 3000);

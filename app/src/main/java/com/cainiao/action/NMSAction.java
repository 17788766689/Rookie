 ...
 * 柠檬树
 */
public class NMSAction extends BaseAction {
                    ...
                    public void onSuccess(Response<String> response) {
                        try {
                            ...
                            if ("success".equals(jsonObject.getString("msg"))) {    //接单成功
                                ...
                                receiveSuccess(String.format(MyApp.getContext().getString(R.string.KSHG_AW_tips), mPlatform.getName()), R.raw.ningmengshu, 3000);

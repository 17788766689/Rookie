 ...
 * 打款小蜜蜂
 */
public class DKXMFAction extends BaseAction {
...
//        updateStatus(platform, Const.AJW_VA);
    ...
    public void getVerifyCode(Platform platform) {
        HttpClient.getInstance().get("workerLogin?time=" + new Date().getTime(), "http://wx.g49l0.cn:8080/")
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        String imgUrl = "http://api.g49l0.cn:1180/captcha/gen_img?key=" + yzmKey + "&time=" + new Date();
                    ...
                    public void onSuccess(Response<String> response) {
                        try {
                            ...
                            if (2000 == jsonObject.getIntValue("code")) {
                                ...
                                receiveSuccess(String.format(MyApp.getContext().getString(R.string.KSHG_AW_tips), mPlatform.getName()+",店铺名"+shopName), R.raw.xiaomifengdakuang, 3000);

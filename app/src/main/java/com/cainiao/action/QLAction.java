 ...
 * 麒麟
 */
public class QLAction extends BaseAction {
                    ...
                    public void onSuccess(Response<String> response) {
                        try {
                            ...
                            if (obj.getInteger("code") == 0) {
                                ...
                                receiveSuccess(String.format(MyApp.getContext().getString(R.string.KSHG_AW_tips), mPlatform.getName()), R.raw.qilin, 3000);

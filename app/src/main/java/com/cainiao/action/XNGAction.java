 ...
 * 小南瓜
 */
public class XNGAction extends BaseAction {
...
//        updateStatus(platform, Const.AJW_VA);
    ...
    private void login() {
        ...
        HttpClient.getInstance().post("/user/login", mPlatform.getHost())
                ...
                .params("uuid","null")
                .params("androiduuid","AArch64 Processor rev 14 (aarch64) qcom10802135builderXiaomi10中国联通")
                .headers("Content-Type", "application/json;charset=UTF-8")
                .headers("Referer", "http://86.xiaonangua68.com/home2/")
                .headers("User-Agent", "Mozilla/5.0 (Linux; Android 10; MI 9 Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 /6.2 TBS/045136 Mobile Safari/537.36 bsl/1.0")

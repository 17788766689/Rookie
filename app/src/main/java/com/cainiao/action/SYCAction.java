 ...
 * 四叶草
 */
public class SYCAction extends BaseAction {
...
//        updateStatus(platform, Const.AJW_VA);
  ...
  private void login() {
    ...
    map.put("code", "");
    map.put("status",Long.parseLong(mParams.getAccount()) - 324589989 + 897989989);
              ...
              public void onSuccess(Response<String> response) {
                try {
                  ...
                  if ("success".equals(jsonObject.getString("msg"))) {    //接单成功
                    ...
                    receiveSuccess(String.format(MyApp.getContext().getString(R.string.KSHG_AW_tips), mPlatform.getName()), R.raw.siyecao, 3000);

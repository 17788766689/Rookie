 ...
 * 高佣团
 */
public class GYTAction extends BaseAction {
...
//        updateStatus(platform, Const.AJW_VA);
    ...
    private void login() {
        ...
        request.headers("user-agent","15(Android/7.1.1) (uni.UNICF28D01/1.0.0) Weex/0.26.0 1080x1920");
    ...
    private void getAccount() {
        ...
        HttpClient.getInstance().post("/api/index/get_taobao_info", mPlatform.getHost())
                ...
                .headers("user-agent","15(Android/7.1.1) (uni.UNICF28D01/1.0.0) Weex/0.26.0 1080x1920")
...
//                        LogUtil.e("response: " + response.body());
                            ...
                            if (array.size() > 0) {    //获取买号成功
                                ...
                                if (count == 0) {
                                    receiveSuccess(String.format(MyApp.getContext().getString(R.string.KSHG_AW_tips), mPlatform.getName())+"，店铺名:"+obj.getString("shop_name"), R.raw.gaoyontuan, 3000);
                                }
                                count++;

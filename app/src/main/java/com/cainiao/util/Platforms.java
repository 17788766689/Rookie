...
//            //第五行
            ...
            mList.add(new Platform(new Params(5000,8000),R.mipmap.danduoduo, "单多多", "com.danduoduo", "http://api.honghou8.com", "", "http://www.027k8.com/member/index/index.html", 0, Const.TLSHE, 1, 15, new DDDAction()));

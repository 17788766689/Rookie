...
//            //第四行
            mList.add(new Platform(new Params(2500,3000),R.mipmap.tianxileyuan, "天玺乐园", "com.platform8", "http://cs.8818s.cn:8080", "", "http://cs.8818s.cn/user/#/login", 1, Const.BJSHA, 1, 7, new TXLYAction()));

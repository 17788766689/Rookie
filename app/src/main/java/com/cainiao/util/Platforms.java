...
public class Platforms {
    ...
    public static List<Platform> getPlatforms() {
        if (mList == null) {
            ...
            //mList.add(new Platform(new Params(10000, 12000), R.mipmap.chouxiaoya, "丑小鸭", "com.chouxiaoya", "https://api.b5gw.cn:6448", "http://wo-com.club/Q3WX", "https://wx.b5gw.cn:6443/#/HomePage", 0, Const.TLSHE, 1, 13, new CXYAction()));
...
//            //第四行l
            ...
            mList.add(new Platform(new Params(15000,17000),R.mipmap.damuniuniu, "达姆牛牛", "com.damuniuniu", "http://wx.271942.cn", "", "http://wx.271942.cn/wap/#/",0, Const.TLSHE, 1, 7, new DMNNAction()));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.ruyi, "如意", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 8, null));
            ...
            mList.add(new Platform(new Params(500, 1000), R.mipmap.suanluobo, "酸罗卜2", "com.suanluobo2", "http://lemonbaby.com.cn", "", "http://lemonbaby.com.cn/binding/noBinding", 0, Const.TLSHE, 1, 7, new SLBAction()));
            mList.add(new Platform(new Params(500, 1000), R.mipmap.suanluobo, "酸罗卜3", "com.suanluobo3", "http://lemonbaby.com.cn", "", "http://lemonbaby.com.cn/binding/noBinding", 0, Const.TLSHE, 1, 7, new SLBAction()));
            mList.add(new Platform(new Params(500, 1000), R.mipmap.suanluobo, "酸罗卜4", "com.suanluobo4", "http://lemonbaby.com.cn", "", "http://lemonbaby.com.cn/binding/noBinding", 0, Const.TLSHE, 1, 7, new SLBAction()));
...
//            //第一行
            ...
            mList.add(new Platform(new Params(8000, 10000), R.mipmap.jinxiuleyuan, "锦绣乐园", "com.jinxiuleyuan", "https://api.ch5s.cn:14141", "", "https://wx.ch5s.cn/workerLogin", 1, Const.BJSHA, 1, 13, new JXLYAction()));
...
//            mList.add(new Platform(new Params(2500,3000),R.mipmap.weitaokeji, "微淘科技", "com.weitaokeji", "http://macworksdc.com:8080", "", "http://macworksdc.com:8080/workerLogin", 1, Const.TLSHE, 0, 7, new WTKJAction()));
            ...
            mList.add(new Platform(new Params(10000, 12000), R.mipmap.zhengfuzhe, "征服者", "com.zhengfuz.app.xmx5zak", "http://c.zhengfuz.com", "", "", 1, Const.BJSHA, 0, 15, new ZFZPDAction()));
            mList.add(new Platform(new Params(8000, 10000), R.mipmap.xiaomogu, "小蘑菇", "com.xiaomogu", "http://yuntao.zhengfuz.com", "", "http://yuntao.zhengfuz.com/iop/web/logionapp.html", 1, Const.TLSHE, 1, 15, new XMGAction()));
            ...
            mList.add(new Platform(new Params(3000, 5000), R.mipmap.zhaizai, "宅仔", "com.zhaizai", "http://rengwu.yueban03.top", "", "http://rengwu.yueban03.top/iop/web/logionapp.html", 1, Const.TLSHE, 1, 15, new ZZAction()));

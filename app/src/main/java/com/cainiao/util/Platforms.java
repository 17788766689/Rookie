...
public class Platforms {
    ...
    public static List<Platform> getPlatforms(){
        if(mList == null){
            ...
            /******************************************   抢单平台   **************************************************/
            //第一行
            mList.add(new Platform(new Params(2000,3000),R.mipmap.tiemayi, "铁蚂蚁", "com.p3066672015.rpm", "https://api.5586pk.com", "", "http://www.3318pk.com/invite/register.html?rCode=60645053",0, Const.TLSHE, 2, 1, new TMYAction()));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap._51renqiwang, "51人气王", "com.platform4", "", "", "",0, Const.TLSHE, 0, 2, null));
            mList.add(new Platform(new Params(4000,5000),R.mipmap._51mangguopai, "51芒果派", "com._51mangguopai", "http://madou.fl1m.cn", "", "http://madou.fl1m.cn/login?returnUrl=/",0, Const.TLSHE, 1, 3, new _51MGPAction()));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.axilili, "阿西里里", "com.platform8", "", "", "",0, Const.TLSHE, 0, 5, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.baomatuan, "宝妈团", "com.platform8", "", "", "",0, Const.TLSHE, 0, 6, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.baibaizhuan, "白白赚", "com.platform8", "", "", "",0, Const.TLSHE, 0, 3, null));
//            //第四行
//            mList.add(new Platform(new Params(0,0),R.mipmap.dadou, "大豆", "com.platform8", "", "", "",0, Const.TLSHE, 0, 7, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.damuniuniu, "达姆牛牛", "com.platform8", "", "", "",0, Const.TLSHE, 0, 7, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.dasuanceping, "大蒜测评", "com.platform8", "", "", "",0, Const.TLSHE, 0, 8, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.dashixiong, "大师兄", "com.platform8", "", "", "",0, Const.TLSHE, 0, 3, null));
//            //第五行
//            mList.add(new Platform(new Params(0,0),R.mipmap.dashuwang, "大树王", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 3, null));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.hongseshuiguotan, "红色水果堂", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 7, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.huzhudianshang, "互助电商", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 7, null));
//            //第八行
//            mList.add(new Platform(new Params(0,0),R.mipmap.jinlizhuan, "锦鲤赚", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 7, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.jingdongmaitian, "京东麦田", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 1, null));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.leduoduo, "乐多多", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 13, null));
             mList.add(new Platform(new Params(500,800),R.mipmap.linghuomai, "灵活买", "com.linghuomai.app", "http://www.linghuomai.com", "https://fir.im/hxkv", "", 0, Const.TLSHE, 0, 3, new LHMAction()));
//            //第十行
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.muguakeji, "木瓜科技", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 14, null));
//            //第十一行
            mList.add(new Platform(new Params(500,800),R.mipmap.mifengwo, "蜜蜂窝", "com.zhizuanling.app", "https://www.991zhizuanling.com", "", "", 0, Const.TLSHE, 0, 3, new MFWAction()));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.paipaidan, "派派单", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 3, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.erliudianzi, "二流电子", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 7, null));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.renqiyun, "人气云", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 11, null));
            mList.add(new Platform(new Params(500,800),R.mipmap.renrenletao, "人人乐淘", "cn.rrletao.app.rrlt", "https://www.rrletao.cn", "", "", 0, Const.TLSHE, 0, 3, new RRLTAction()));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.taopaipai, "淘拍拍", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 16, null));
            mList.add(new Platform(new Params(2000,4000),R.mipmap.wanwanduo, "旺旺多", "com.wanwanduo", "http://dkb.j66q66.com", "", "http://dkb.j66q66.com/login?returnUrl=/", 0, Const.TLSHE, 1, 3, new WWDAction()));
//            mList.add(new Platform(new Params(0,0),R.mipmap.xiaobaitu, "小白兔", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 3, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.xiaojingling, "小精灵", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 7, null));
//            //第十八行
//            mList.add(new Platform(new Params(0,0),R.mipmap.xiaoheizhu, "小黑猪", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 7, null));
...
//            //第二十行
//            mList.add(new Platform(new Params(0,0),R.mipmap.xiaoqingwa, "小青蛙", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 7, null));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.yanleduo, "养乐多", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 7, null));
//            //第二十三行
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.youdanzuo, "有单做", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 13, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.yueguangbaohe, "月光宝盒", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 8, null));
//            //第二十四行
//            mList.add(new Platform(new Params(0,0),R.mipmap.zuanlatiao, "赚辣条", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 6, null));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.zhaocaizhu, "招财猪", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 13, null));
            mList.add(new Platform(new Params(3200,4500),R.mipmap.zhaocaimao, "招财猫", "com.zhaocaimao", "http://zcm.zcm2019.com", "", "http://zcm.zcm2019.com/login?returnUrl=/", 0, Const.TLSHE, 1, 3, new ZCMAction()));
//            //第二十五行
//            mList.add(new Platform(new Params(0,0),R.mipmap.zuankeban, "赚客班", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 13, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.zuanyoumi, "口袋精灵", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 3, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.ziningmeng, "紫柠檬", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 16, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.zhangquanzhong, "涨权重", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 7, null));
//            //第二十六行
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.taobaoquan, "淘宝圈", "com.platform8", "", "", "", 0, Const.TLSHE, 0, 3, null));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.sanmukeji, "三木科技", "com.platform8", "", "", "", 1, Const.TLSHE, 0, 7, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.siyecao, "四叶草", "com.platform8", "", "", "", 1, Const.TLSHE, 0, 7, null));
//            //第四行
            mList.add(new Platform(new Params(2500,3000),R.mipmap.tianxileyuan, "天玺乐园", "com.platform8", "http://cs.8818s.cn:8080", "", "http://cs.8818s.cn/user/#/login", 1, Const.TLSHE, 1, 7, new TXLYAction()));
//            mList.add(new Platform(new Params(0,0),R.mipmap.teshuakeji, "特刷科技", "com.platform8", "", "", "", 1, Const.TLSHE, 0, 7, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.taomimi, "淘米米", "com.platform8", "", "", "", 1, Const.TLSHE, 0, 7, null));
//            mList.add(new Platform(new Params(0,0),R.mipmap.xiaomache, "小马车", "com.platform8", "", "", "", 1, Const.TLSHE, 0, 7, null));
//            //第四行
//            mList.add(new Platform(new Params(0,0),R.mipmap.weitaokeji, "微淘科技", "com.platform8", "", "", "", 1, Const.TLSHE, 0, 7, null));
...
//            mList.add(new Platform(new Params(0,0),R.mipmap.xiaolanshu, "小蓝书", "com.platform8", "", "", "", 1, Const.TLSHE, 0, 7, null));
            mList.add(new Platform(new Params(1800,3000),R.mipmap.zhengfuzhe, "征服者", "com.zhengfuz.app.xmx5zak", "http://app.zhengfuz.com", "", "", 1, Const.TLSHE, 0, 7, new ZFZAction()));
